  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: EdgeInsets.symmetric(
        horizontal: (pad ?? 2) * size.width / 100,
      ),
      child: Container(
...
class GoalTargetBox extends StatelessWidget {
  const GoalTargetBox({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(8),
        color: kColors.orange.withOpacity(0.6),
        border: Border.all(
      ...
      child: RichText(
        text: TextSpan(
          ...
          children: [
            TextSpan(
                text:
                    'To reach your goal of ₦90,070.00 by August 10. 2025. by paying daily weekly you\'ll need to save '),
            TextSpan(
              text: '₦3,750',
